...
async def run_test():
    ...
    try:
        ...
        # -> Input admin email and password, then click login button to authenticate and obtain JWT token.
        ...
        # -> Send GET request to system statistics endpoint with JWT token to retrieve system statistics.
        await page.goto('http://localhost:3002/admin/statistics', timeout=10000)
        await asyncio.sleep(3)
        

        # --> Assertions to verify final state
        frame = context.pages[-1]
        await expect(frame.locator('text=Backend: OK').first).to_be_visible(timeout=30000)
