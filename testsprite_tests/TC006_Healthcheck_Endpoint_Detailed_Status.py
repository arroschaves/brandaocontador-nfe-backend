...
async def run_test():
    ...
    try:
        ...
        # -> Send a GET request to the detailed healthcheck endpoint to verify HTTP 200 and system/memory status.
        await page.goto('http://localhost:3002/healthcheck/detailed', timeout=10000)
