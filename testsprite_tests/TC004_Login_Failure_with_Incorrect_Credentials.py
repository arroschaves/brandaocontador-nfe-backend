...
async def run_test():
    ...
    try:
        ...
        # -> Input invalid email and incorrect password, then click the login button.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=Email ou senha inválidos.').first).to_be_visible(timeout=30000)
