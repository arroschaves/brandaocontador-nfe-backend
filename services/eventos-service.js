...
class EventosService {
  ...
  async cancelarNfe(dadosCancelamento) {
    try {
      this.logService.info("Iniciando cancelamento de NFe", {
  ...
  async cartaCorrecao(dadosCorrecao) {
    try {
      this.logService.info("Enviando carta de correção", {
  ...
  async devolucao(dadosDevolucao) {
    try {
      this.logService.info("Processando evento de devolução", {
  ...
  async estorno(dadosEstorno) {
    try {
      this.logService.info("Processando evento de estorno", {
