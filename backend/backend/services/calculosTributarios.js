...
class CalculosTributariosService {
  constructor() {
    ...
    this.aliquotasSimples = {
      comercio: [
        { faixa: 180000, aliquota: 4.00, icms: 1.25, irpj: 0.00, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 0.00 },
        { faixa: 360000, aliquota: 7.30, icms: 1.86, irpj: 0.00, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 2.69 },
        { faixa: 720000, aliquota: 9.50, icms: 2.33, irpj: 0.24, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 4.18 },
        { faixa: 1800000, aliquota: 10.70, icms: 2.56, irpj: 0.27, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 5.12 },
        { faixa: 3600000, aliquota: 14.30, icms: 2.33, irpj: 0.35, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 8.87 },
        { faixa: 4800000, aliquota: 19.00, icms: 2.33, irpj: 0.35, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 13.57 }
      ],
      industria: [
        { faixa: 180000, aliquota: 4.50, icms: 1.25, irpj: 0.00, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 0.50 },
        { faixa: 360000, aliquota: 7.80, icms: 1.86, irpj: 0.00, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 3.19 },
        { faixa: 720000, aliquota: 10.00, icms: 2.33, irpj: 0.24, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 4.68 },
        { faixa: 1800000, aliquota: 11.20, icms: 2.56, irpj: 0.27, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 5.62 },
        { faixa: 3600000, aliquota: 14.70, icms: 2.33, irpj: 0.35, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 9.27 },
        { faixa: 4800000, aliquota: 30.00, icms: 2.33, irpj: 0.35, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 2.75, ipi: 24.57 }
      ],
      servicos: [
        { faixa: 180000, aliquota: 6.00, iss: 2.00, irpj: 0.00, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 4.00 },
        { faixa: 360000, aliquota: 11.20, iss: 3.50, irpj: 0.00, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 7.70 },
        { faixa: 720000, aliquota: 13.50, iss: 4.00, irpj: 0.16, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 9.34 },
        { faixa: 1800000, aliquota: 16.00, iss: 4.00, irpj: 0.52, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 11.48 },
        { faixa: 3600000, aliquota: 21.00, iss: 4.00, irpj: 0.89, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 16.11 },
        { faixa: 4800000, aliquota: 33.00, iss: 4.00, irpj: 1.42, csll: 0.00, cofins: 0.00, pis: 0.00, cpp: 27.58 }
      ]
    };

    // Alíquotas ICMS por UF (2025)
    this.aliquotasICMS = {
      'AC': { interna: 17.00, interestadual: 12.00 },
      'AL': { interna: 17.00, interestadual: 12.00 },
      'AP': { interna: 18.00, interestadual: 12.00 },
      'AM': { interna: 18.00, interestadual: 12.00 },
      'BA': { interna: 18.00, interestadual: 12.00 },
      'CE': { interna: 18.00, interestadual: 12.00 },
      'DF': { interna: 18.00, interestadual: 12.00 },
      'ES': { interna: 17.00, interestadual: 12.00 },
      'GO': { interna: 17.00, interestadual: 12.00 },
      'MA': { interna: 18.00, interestadual: 12.00 },
      'MT': { interna: 17.00, interestadual: 12.00 },
      'MS': { interna: 17.00, interestadual: 12.00 },
      'MG': { interna: 18.00, interestadual: 12.00 },
      'PA': { interna: 17.00, interestadual: 12.00 },
      'PB': { interna: 18.00, interestadual: 12.00 },
      'PR': { interna: 18.00, interestadual: 12.00 },
      'PE': { interna: 18.00, interestadual: 12.00 },
      'PI': { interna: 18.00, interestadual: 12.00 },
      'RJ': { interna: 20.00, interestadual: 12.00 },
      'RN': { interna: 18.00, interestadual: 12.00 },
      'RS': { interna: 18.00, interestadual: 12.00 },
      'RO': { interna: 17.50, interestadual: 12.00 },
      'RR': { interna: 17.00, interestadual: 12.00 },
      'SC': { interna: 17.00, interestadual: 12.00 },
      'SP': { interna: 18.00, interestadual: 12.00 },
      'SE': { interna: 18.00, interestadual: 12.00 },
      'TO': { interna: 18.00, interestadual: 12.00 }
    };

    // Alíquotas PIS/COFINS
    this.aliquotasPisCofins = {
      lucroReal: { pis: 1.65, cofins: 7.60 },
      lucroPresumido: { pis: 0.65, cofins: 3.00 },
      simplesNacional: { pis: 0.00, cofins: 0.00 } // Incluído no DAS
    };
    ...
    this.aliquotas2026 = {
      ...
      is: 1.00,  // Imposto Seletivo (produtos específicos)
  ...
  calcularSimplesNacional(dados) {
    const { faturamento12Meses, valorProdutos, uf, tipoAtividade = 'comercio' } = dados;
    
    const faixas = this.aliquotasSimples[tipoAtividade] || this.aliquotasSimples.comercio;
    ...
    for (const produto of valorProdutos) {
      ...
      const impostos = {
        ...
        observacoes: this.gerarObservacoesSimplesNacional(faixaAtual, tipoAtividade)
      };
  ...
  calcularLucroPresumidoReal(dados) {
    const { valorProdutos, uf, ufDestino, tipoRegime = 'presumido', tipoOperacao = 'venda' } = dados;
    ...
    for (const produto of valorProdutos) {
      ...
      // ICMS
      const aliquotaICMS = this.calcularAliquotaICMS(uf, ufDestino, tipoOperacao);
      const valorICMS = valorTotal * (aliquotaICMS / 100);

      // PIS/COFINS
      const aliquotasPis = this.aliquotasPisCofins[tipoRegime === 'presumido' ? 'lucroPresumido' : 'lucroReal'];
  ...
  calcularSubstituicaoTributaria(dados) {
    ...
    for (const produto of valorProdutos) {
      ...
      const valorICMSST = (baseCalculoST * (aliquotaICMSST / 100)) - valorICMSProprio;
  ...
  simular2026(dados) {
    ...
    for (const produto of valorProdutos) {
      ...
      const impostos = {
        ...
        is: incluirIS && produto.sujeitoIS ? {
          valor: valorIS,
    ...
    return {
      ...
      totalImpostos,
      produtos: resultados,
      observacoesGerais: 'Simulação baseada na Reforma Tributária. Valores sujeitos a alterações até a implementação final.',
      beneficios: [
  ...
  compararRegimes(dados) {
    ...
    const lucroPresumido = this.calcularLucroPresumidoReal({ ...dados, tipoRegime: 'presumido' });
    const lucroReal = this.calcularLucroPresumidoReal({ ...dados, tipoRegime: 'real' });
    ...
    return {
      ...
      lucroReal,
      simulacao2026,
      melhorOpcao: this.determinarMelhorRegime([simplesNacional, lucroPresumido, lucroReal]),
      economia2026: simulacao2026.totalImpostos < simplesNacional.totalImpostos ? 
        simplesNacional.totalImpostos - simulacao2026.totalImpostos : 0
    };
  }
