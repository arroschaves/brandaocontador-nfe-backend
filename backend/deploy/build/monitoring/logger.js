...
const mainLogger = winston.createLogger({
  ...
  format: monitoringConfig.logging.format === 'json' ? jsonFormat : simpleFormat,
  defaultMeta: {
    service: 'nfe-backend',
  ...
  transports: [
    ...
    new winston.transports.Console({
      format: monitoringConfig.environment === 'production' ? jsonFormat : simpleFormat
    }),
...
const securityLogger = winston.createLogger({
  ...
  transports: [
    createFileTransport(monitoringConfig.logging.files.security)
  ]
});
...
const performanceLogger = winston.createLogger({
  ...
  transports: [
    createFileTransport(monitoringConfig.logging.files.performance)
  ]
});
...
const nfeLogger = winston.createLogger({
  ...
  transports: [
    createFileTransport(monitoringConfig.logging.files.nfe)
  ]
});
