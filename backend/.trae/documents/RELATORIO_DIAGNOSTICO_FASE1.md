...
```json
{
  ...
  "perfil": "admin",
  "permissoes": [
    "all", "admin", "admin_total",
    "nfe_emitir", "nfe_consultar", "nfe_cancelar",
    "clientes_gerenciar", "produtos_gerenciar",
    "relatorios_acessar", "configuracoes_gerenciar",
    "dashboard_acessar", "sistema_administrar"
  ],
  "ativo": true,
  "isAdmin": true,
  "accessLevel": "full"
