...
async function confirmarLimpeza() {
  ...
  return new Promise((resolve) => {
    console.log('\n╔════════════════════════════════════════════════════════════════╗');
    console.log('║    LIMPEZA DE DADOS - Sistema NFe Brandão Contador           ║');
    console.log('╚════════════════════════════════════════════════════════════════╝\n');
    ...
    console.log('   • Usuário administrador (cjbrandao@brandaocontador.com.br)');
...
async function limparDados() {
  ...
  try {
    if (fs.existsSync(usersPath)) {
      ...
      // Encontrar admin
      const admin = users.find(u => u.email === 'cjbrandao@brandaocontador.com.br');
